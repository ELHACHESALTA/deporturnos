...
const Footer = () => {
    return (
        <footer className="mt-auto border-gray-200 dark:border-neutral-700">
            <div className="w-full max-w-[66rem] py-3 px-6 mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-2">
                    ...
                    <div className="flex justify-center md:justify-end gap-2">
                        <a className="whitespace-nowrap w-auto py-2 inline-flex justify-center md:justify-end items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-black hover:text-gray-600 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:hover:text-neutral-400" href="https://github.com/guillermoagueronqn">
