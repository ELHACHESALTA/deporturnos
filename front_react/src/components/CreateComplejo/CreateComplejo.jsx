...
const CreateComplejo = ({ servicios }) => {
    ...
    return (
        <>
            <h2 className="text-2xl font-bold text-center my-4 dark:text-white">Ingresa los datos de tu complejo:</h2>
            <div className="mt-4">
