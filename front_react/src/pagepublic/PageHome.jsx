    ...
    return (
        <div className="flex-grow dark:bg-neutral-900  dark:text-white">
            ...
            <div data-hs-carousel='{
                    ...
                    "isInfiniteLoop": true,
                    "slidesQty": 1
                }' class="relative max-w-[66rem] mx-auto">
                ...
                <div class="dark:bg-neutral-600 hs-carousel-info inline-flex justify-center px-4 absolute bottom-3 start-[50%] -translate-x-[50%] bg-white rounded-lg">
