                ...
                <div className="">
                    <div className="flex mx-auto max-w-[66rem] px-2">
                        <div className="w-full">
                            <button onClick={openModalCreate} className="bg-lime-500 text-white px-6 py-2 mb-4 mt-4 rounded-lg shadow-md transition-transform transform hover:scale-105 hover:bg-lime-600 focus:outline-none focus:ring-2 focus:ring-lime-400 focus:ring-offset-2">
                                Crear nueva cancha
                            </button>
                        </div>
                    </div>
