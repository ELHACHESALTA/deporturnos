        ...
        <div className="flex-grow">
            ...
            <div className="flex flex-col mx-auto max-w-[66rem] px-2 mt-4">
                <div className="bg-gray-100 dark:bg-neutral-800 rounded-3xl overflow-hidden border border-gray-200 dark:border-neutral-700 shadow-md dark:shadow-neutral-700/70">
                    <div className="flex mx-auto max-w-[66rem] p-4 pt-4">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full">
                            {complejosFavoritos.length === 0 ? (
                                <div className="col-span-1 sm:col-span-2 lg:col-span-3 text-center p-4">
                                    <p className="text-gray-600 dark:text-neutral-400 font-semibold">No tienes complejos favoritos agregados.</p>
                                    <p className="text-gray-500 dark:text-neutral-500">Agrega alguno a tu lista de favoritos.</p>
                                </div>
                            ) : (
                                complejosFavoritos.map(complejo => (
                                    <div key={complejo.id} className="flex flex-col rounded-3xl bg-gray-100 dark:bg-neutral-900 border border-gray-200 dark:border-neutral-700 shadow-md dark:shadow-neutral-700/70">
                                        <img className="object-cover w-full h-[200px] rounded-t-3xl" src="/cancha01.jpg" alt="cancha" />
                                        <div className="relative">
                                            <div className="absolute top-[-16px] left-0 h-[16px] bg-gray-100 dark:bg-neutral-900 rounded-t-3xl w-full"></div>
