...
class TurnosTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $turno1->estadoDisponible = "no disponible";
        $turno1->metodoPago = "mercado pago";
        $turno1->timerPago = "00:05:00";
        $turno1->timerReprogramacion = 10;
        $turno1->precio = 15000;
        $turno1->save();
        ...
        $turno2->estadoDisponible = "no disponible";
        $turno2->metodoPago = "mercado pago";
        $turno2->timerPago = "00:05:00";
        $turno2->timerReprogramacion = 9;
        $turno2->precio = 16000;
        $turno2->save();
        ...
        $turno7->estadoDisponible = "no disponible";
        $turno7->metodoPago = "mercado pago";
        $turno7->timerPago = "00:05:00";
        $turno7->timerReprogramacion = 72;
        $turno7->precio = 16000;
        $turno7->save();
        ...
        $turno10->timerReprogramacion = 30;
        ...
        $turno11->timerReprogramacion = 24;
        ...
        $turno12->estadoDisponible = "no disponible";
        $turno12->metodoPago = "mercado pago";
        $turno12->timerPago = "00:05:00";
        $turno12->timerReprogramacion = 24;
        ...
        $turno13->timerReprogramacion = 10;
        ...
        $turno14->timerReprogramacion = 48;
        ...
        $turno15->timerReprogramacion = 24;
